              ...
              <div class="row">
                   <div class="col-md-5 ">
                        <div class="container-fluid">
                             <h1 class="headingServices">Story Writing</h1>
                             ...
                             <p class="text-white"><small class="text-white">Already a TotalAssignmentHelp member? <a
                                            class="text-muted" href="#" style="text-decoration: none;">Login
                                       </a></small></p>
