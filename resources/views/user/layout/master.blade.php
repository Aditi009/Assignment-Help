...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div id="id01" class="modal">
      <div class="modal-content animate" style="max-width: 500px">
    ...
    <div class="container-fluid top_nav">
      ...
      <div class="col-xl-6 col-lg-7 col-md-10 top_nav_right_align_content">
        <ul style="width:auto;">
          ...
          <li style="float:left;list-style:none;padding-left:10px;"><a class="btn btn-sm btn-primary mr-4 top_nav_getassist" href="newassignment"  style="width:auto;">Order Now</a></li>
        </ul>
      </div>
    </div>
...
<!--
    ...
    <a class="btn btn-primary"  onclick="document.getElementById('id01').style.display='block'"  style="color: white">LOGIN</a>
      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-3" style="padding-top:30px;">
          <div class="container-fluid" style="text-align:center;color:#fcfcfc;width:200px;background-color:#696969;padding:10px;">
            ...
            <a class="btn btn primary"href="newassignment" style="background-color:#5F9EA0;color:#fcfcfc;width:auto;" >Order Now</a>
          </div>
        </div>
      </div>
